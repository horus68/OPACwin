...
(function(jQuery) {
  jQuery.fn.tagBox = function(options) {
    var defaults = {
      ...
      tagInputClassName: '',
      tagButtonClassName: '',
      tagButtonTitle: '../../imagens/icon_tags.gif',
...
//  Hide Element
  ...
  //  Create DOM Elements
      ...
      var $tag_add_elem = (options.readonly) ? '' : jQuery('<a href="javascript:void(0)" ><img border="0" src="'+options.tagButtonTitle+'" alt="Adicionar tag"></a>');
