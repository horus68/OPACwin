...
<script type="text/javascript">
	...
	<%if valores(6)="S" then %> 
		...
		<% end if%>
	chart.draw(data, {width: 575, height: 296, enableTootlTip: true,  axisFontSize: 11, is3D: true, colors:[{color:'blue', darker:'gray'} ,{color:'red', darker:'gray'}], title: ''});
...
<%if valores(6)="S" then %> 
		...
		<% end if%>
	chart.draw(data, {max: <%=maxi%>, width: 575, height: 296, enableTootlTip: true,  axisFontSize: 11, is3D: true, colors:[{color:'blue', darker:'gray'} ,{color:'cyan', darker:'gray'}], title: ''});
...
function drawChart2() {
	...
	<%if valores(6)="S" then %> 
		...
		<% end if%>	chart.draw(data, {max: <%=maxi%>, width: 575, height: 296, enableTootlTip: true,  axisFontSize: 11, is3D: true, colors:[{color:'red', darker:'gray'} ,{color:'cyan', darker:'gray'}], title: ''});
...
<div id="admbotoes" style="float:right"><a href="admin.asp?id=2&mnres=2"><img src="../imagens/close.gif" border=0 alt="Voltar à página anterior"></a><% if flag=1 then %><a href="javascript:window.print()"><img src="../imagens/imprimir.gif" border=0 alt="Imprimir esta página"></a><%end if%></div><h3>Reservas [entidades requisitadas]</h3>  
	...
	<div id="painel">
		<div  id="tab1" class="tabcontent">
			...
			<table>
			<tr>
			<td><div id="chart_div" style="width:580px;">A carregar dados... Aguarde um momento, por favor</div></td>
			<td>
			<%
			if flag=1 then
			%>
		...
		<div  id="tab2" class="tabcontent">
			...
			<b>B - Pedidos totais vs confirmados: [E.I.B.]</b>
			<table>
			<tr>
			<td><div id="chart_div1" style="width:580px;">A carregar dados... Aguarde um momento, por favor</div></td>
			<td>
			<%
			if flag=1 then
			%>
		...
		<b>C) Pedidos totais vs confirmados: [Leitores]</b>
			<table>
			<tr>
			<td><div id="chart_div2" style="width:580px;">A carregar dados... Aguarde um momento, por favor</div></td>
			<td>
			<%
			if flag=1 then
			%>
